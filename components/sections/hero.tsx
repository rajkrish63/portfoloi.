...
export default function Hero() {
    ...
    const track1 = [
        "/hero-slider/rajkrish1.jpg",
        "/hero-slider/rajkrish2.jpg",
        "/hero-slider/rajkrish3.jpg",
        "/hero-slider/rajkrish4.jpg",
        "/hero-slider/rajkrish5.jpg",
        "/hero-slider/rajkrish6.jpg"
    ];
            ...
            >
                ...
                <div className="w-full mt-auto flex flex-col justify-center relative z-20 mix-blend-difference">
                    <div className="overflow-hidden">
                        <h1 className="font-[family-name:var(--font-press-start)] tracking-tighter text-foreground uppercase whitespace-nowrap">
                            <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-[100px] leading-none block">
                                Rajesh
                            </span>
                            <span className="text-[18px] sm:text-[24px] md:text-[30px] lg:text-[36px] xl:text-[48px] 2xl:text-[50px] leading-none text-foreground/80 block mt-3 sm:mt-4 md:mt-5">
