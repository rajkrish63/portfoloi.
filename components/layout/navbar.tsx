  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-sm sm:text-base font-[family-name:var(--font-press-start)] text-foreground uppercase tracking-wider transition-all duration-300 group-hover:opacity-70">
            Rajesh
          </span>
        </Link>
